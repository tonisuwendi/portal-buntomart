...
export default function Button({
    ...
    case 'primary':
        isDark = true;
        variantClasses = 'buntomart-bg-color-primary text-white buntomart-bg-color-primary-hover';
        break;
    case 'secondary':
        isDark = true;
        variantClasses = 'buntomart-bg-color-secondary text-white buntomart-bg-color-secondary-hover';
        break;
    case 'light':
        isDark = false;
    ...
    case 'outline-primary':
        isDark = false;
        variantClasses = 'bg-white box-border border buntomart-border-color-primary border-2 buntomart-text-color-primary hover:bg-slate-200';
        break;
    case 'outline-slate':
        isDark = false;
        variantClasses = 'bg-white box-border border border-slate-300 border-1 text-slate-600 hover:bg-slate-200';
        break;
    default:
        isDark = true;
    }
